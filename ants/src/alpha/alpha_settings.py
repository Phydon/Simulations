...
settings["food_position_x"] = (
    randrange(1, 80, 2) if settings["velocity"] % 2 != 0 else randrange(2, 80, 2)
)
...
settings["home_x"] = (
    settings["WIDTH"] // 2 - settings["home_width"] // 2
)  # home start x
settings["home_y"] = (
    settings["HEIGHT"] // 2 - settings["home_height"] // 2
)  # home start y
